...
public class Splach extends AwesomeSplash {
   ...
   /* you don't have to override every property */
        ...
        configSplash.setPathSplashStrokeColor(R.color.splach); //any color you want form colors.xml
        configSplash.setAnimPathFillingDuration(3000);
        configSplash.setPathSplashFillColor(R.color.splach); //path object filling color
